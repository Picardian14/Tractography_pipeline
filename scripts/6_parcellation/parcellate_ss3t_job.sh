...
mri_aparc2aseg -s "$subject_folder" \
    -o "$SUBJECTS_DIR/$subject_folder/mri/$ATLAS_LABEL_NAME.mgz" \
    -annot "$ATLAS_LABEL_NAME"
mrconvert "$SUBJECTS_DIR/$subject_folder/mri/${ATLAS_LABEL_NAME}.mgz" \
    "$SUBJECTS_DIR/$subject_folder/mri/${ATLAS_LABEL_NAME}.nii.gz" -force
labelconvert \
    "$SUBJECTS_DIR/$subject_folder/mri/${ATLAS_LABEL_NAME}.nii.gz" \
